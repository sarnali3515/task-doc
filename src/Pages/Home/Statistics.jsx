        ...
        <div className="mt-12 max-w-7xl mx-auto">
            <div className="grid md:grid-cols-5 md:gap-5">
                ...
                <div className="bg-[#FBFBFB] text-[#020043] rounded-3xl border p-5 space-y-2 border-[#02144333]">
                    <h1 className="text-xl md:text-[40px] py-2 font-semibold ">90%</h1>
                ...
                <div className="col-span-3">
                    ...
                    <div className='grid md:grid-cols-3 gap-5 mt-5'>
                        ...
                        <div className="bg-[#FFFFF5] text-[#020043] rounded-3xl border p-5 space-y-1 border-[#02144333]">
                            <h1 className="text-xl md:text-[40px] py-2 font-semibold ">500+</h1>
                            <p className=' text-sm'>
                        ...
                        <div className='flex items-end'>
                            <div className="bg-[#FBFBFB] text-[#020043] rounded-3xl border p-5 space-y-1 border-[#02144333] h-40 w-full">
                                <h1 className="text-xl md:text-[40px] py-2 font-semibold ">4.8</h1>
                                <p className=' text-sm'>
                                    Over 20,000 Patient
                                </p>
                        ...
                        {/* middle-3 */}
                        <div className="bg-[#FFFFF5] text-[#020043] rounded-3xl border p-5 space-y-1 border-[#02144333]">
                            <h1 className="text-xl md:text-[40px] py-2 font-semibold ">$5000</h1>
                            <p className=' text-sm'>
                                Money spend <br />
                                for poor patient
                            </p>
                ...
                {/* right */}
                <div className="bg-[#FBFBFB] text-[#020043] rounded-3xl border p-5 space-y-2 border-[#02144333]">
                    <h1 className="text-xl md:text-[40px] py-2 font-semibold ">50+</h1>
